exports.seed = function(knex, Promise) {
  return Promise.all([
    ...
    knex('orders').insert({id: 4, created: new Date('2019-05-02'), fulfilled: null, status: 'pending', userid: 2}),
    knex('orders').insert({id: 5, created: new Date('2019-05-03'), fulfilled: null, status: 'pending', userid: 2})
  ]);
